...
"[externals]/axios [external] (axios, cjs)": (function(__turbopack_context__) {

var { r: __turbopack_require__, f: __turbopack_module_context__, i: __turbopack_import__, s: __turbopack_esm__, v: __turbopack_export_value__, n: __turbopack_export_namespace__, c: __turbopack_cache__, M: __turbopack_modules__, l: __turbopack_load__, j: __turbopack_dynamic__, P: __turbopack_resolve_absolute_path__, U: __turbopack_relative_url__, R: __turbopack_resolve_module_id_path__, b: __turbopack_worker_blob_url__, g: global, __dirname, x: __turbopack_external_require__, y: __turbopack_external_import__, m: module, e: exports, t: __turbopack_require_real__ } = __turbopack_context__;
{
const mod = __turbopack_external_require__("axios", () => require("axios"));
...
const axios = __turbopack_require__("[externals]/axios [external] (axios, cjs)");
...
async function handler(req, res) {
    try {
        ...
        switch(action){
            case "createOrder":
                response = await axios.post(`${SHIPROCKET_BASE_URL}/orders/create/adhoc`, payload, config);
                break;
            case "updateOrder":
                response = await axios.post(`${SHIPROCKET_BASE_URL}/orders/update/adhoc`, payload, config);
                break;
            case "cancelOrder":
                response = await axios.post(`${SHIPROCKET_BASE_URL}/orders/cancel`, payload, config);
                break;
            case "generateLabel":
                response = await axios.post(`${SHIPROCKET_BASE_URL}/courier/generate/label`, payload, config);
                break;
            case "printInvoice":
                response = await axios.post(`${SHIPROCKET_BASE_URL}/orders/print/invoice`, payload, config);
                break;
            default:
                res.status(400).json({
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__1fdeb8._.js.map